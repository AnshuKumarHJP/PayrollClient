      ...
      <DropdownMenuContent asChild side="bottom" align="end">
        <motion.div
          ...
          className="
            ...
            rounded-md border border-indigo-200/60 bg-indigo-50/60
            ...
            <ul className="flex flex-col overflow-y-auto custom-scrollbar">
              {Array.from({ length: 5 }).map((_, index) => (
                ...
                >
                  <DropdownMenuItem
                    className="
                      flex gap-3 rounded-lg border-b border-indigo-200/40 p-3 
                      hover:!bg-indigo-100/60 focus:!bg-indigo-100/60
                  ...
                  >
                    ...
                    <span className="relative block w-10">
                      ...
                      />
                      <span className="absolute bottom-0 right-0 h-2.5 w-2.5 bg-indigo-500 rounded-full border border-white"></span>
                    </span>
            ...
            <motion.div whileTap={{ scale: 0.97 }} className="mt-3">
              <Link
                ...
                className="
                  ...
                  border border-indigo-200 bg-indigo-100/40
                  hover:bg-indigo-200/60 text-indigo-800
