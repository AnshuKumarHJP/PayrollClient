...
export default function BulkUpload({ Template, onSuccess, onCancel }) {
  ...
  return (
    ...
    >
      {/* HEADER */}
      <div className="bg-gradient-to-r from-blue-700 to-indigo-600 rounded-sm
       flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center
         px-4 sm:px-6 py-3 sm:py-2 border-b">
      ...
      <div className="flex justify-end gap-3 bg-white p-2 shadow-sm">
